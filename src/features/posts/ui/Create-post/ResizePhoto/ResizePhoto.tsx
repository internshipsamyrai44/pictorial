...
export const ResizePhoto = () => {
  return (
    <div className={s.wrapper}>
          ...
          <div className={s.checkbox}>
            ...
            >
              <g clip-path="url(#clip0_306_5083)">
                ...
                <path d="M16 20C17.6569 20 19 18.6569 19 17C19 15.3431 17.6569 14 16 14C14.3431 14 13 15.3431 13 17C13 18.6569 14.3431 20 16 20Z" />
              </g>
              <defs>
      ...
      <div className={s.item}>
        <label htmlFor="square" className="checkbox">
          <span className={s.label}>1:1</span>
          <div className={s.checkbox}>
            <svg
              className={`${s.icon} ${s.square}`}
              width="18"
              height="18"
              viewBox="0 0 18 18"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
              <rect x="1" y="1" width="16" height="16" rx="2" stroke-width="2" />
            </svg>
          </div>
          <input type="checkbox" id="square" name="square" />
        </label>
      </div>
      <div className={s.item}>
        <label htmlFor="vertical" className="checkbox">
          <span className={s.label}>4:5</span>
          <div className={s.checkbox}>
            <svg
              className={`${s.icon} ${s.vertical}`}
              width="18"
              height="26"
              viewBox="0 0 18 26"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
              <rect x="1" y="1" width="16" height="24" rx="2" stroke-width="2" />
            </svg>
          </div>
      ...
      <div className={s.item}>
        <label htmlFor="horizontal" className="checkbox">
          <span className={s.label}>16:9</span>
          <div className={s.checkbox}>
            <svg
              className={`${s.icon} ${s.horizontal}`}
              width="26"
              height="20"
              viewBox="0 0 26 20"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
              <rect x="25" y="1" width="18" height="24" rx="2" transform="rotate(90 25 1)" stroke-width="2" />
            </svg>
          </div>
